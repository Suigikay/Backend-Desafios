...
await manager.addProduct("Exfoliante AHA", "Exfoliante químico para piel sensible", "$3500", "AHA.img", "1", "35")
await manager.addProduct("Solar SPF+50", "Protector solar facial", "$5000", "SPF50.img", "2", "20") 
